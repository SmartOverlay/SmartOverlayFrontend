...
class so_abstractStyle {
    ...
    constructor() {
        this.width.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.height.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.positionX.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.positionY.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.background.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.color.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.fontSize.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.fontFamily.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.fontWeight.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.fontStyle.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.textAlign.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.textDecoration.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.lineHeight.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.letterSpacing.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.border.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.borderRadius.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.boxShadow.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.overflow.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
        this.zIndex.addEventListener("update", (e) => {
            this.triggerUpdate();
        });
    }
}
...
class so_domElement extends so_abstractElement {
    ...
    constructor() {
        ...
        this.style.addEventListener("update", (e) => {
            this.updateStyle();
        });
    }
    updateStyle() {
